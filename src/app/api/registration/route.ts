...
export async function POST(request: Request) {
    try {
        ...
        const registrationResponse = await fetch("http://localhost:8080/api/Account/registration", {
            method: "POST",
        ...
        const authResponse = await fetch("http://localhost:8080/api/Account/authentication", {
            method: "POST",
            headers: { "Content-Type": "application/json" },
